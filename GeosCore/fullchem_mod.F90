...
!             ENDIF
       ...
       ELSE
          ...
          ! from autogenerated KPP list of LO3, not completely accurate:
          !
          ! A(1) SALAAL + SO2 + O3 --> LOx + PSO4 + SO4 - SALAAL
          ! A(4) SALCAL + SO2 + O3 --> SO4s + LOx - SALCAL
          ! A(8) SO2 + O3 --> PSO4AQ + LOx + PSO4 + SO4
          ! xxx not a o3 loss xxx A(13) NO + O3 --> NO2 + O2
          ! A(14) O3 + OH --> LOx + HO2 + O2 (in CC)
          ...
          ! xxx not a o3 loss xxx A(738) O3 --> O + O2
